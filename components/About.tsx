        ...
        <div className="py-20 bg-white">
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center mb-16">
                    ...
                    <div className="bg-bege-areia p-6 rounded-lg inline-block">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl card-hover">
                        ...
                        <h3 className="text-2xl font-bold text-azul-marinho mb-4">Missão</h3>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl card-hover">
                        ...
                        <h3 className="text-2xl font-bold text-verde-escuro mb-4">Visão</h3>
                        <p className="text-gray-700">
                            Ser referência em projetos educativos de proteção costeira no litoral oeste do Ceará.
                        </p>
                    </div>
                    
                    <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-8 rounded-xl card-hover">
                        <div className="text-yellow-700 text-5xl mb-4">
                            <i className="fas fa-heart"></i>
                        </div>
                        <h3 className="text-2xl font-bold text-yellow-800 mb-4">Valores</h3>
                        <p className="text-gray-700">
